...
package catalogoempresa.appweb.controllers;
...
import catalogoempresa.accesoadatos.ContactoDAL;
import catalogoempresa.entidadesdenegocio.Contacto;
import catalogoempresa.appweb.utils.*;
...
public class ContactoServlet extends HttpServlet {
   ...
   private Contacto obtenerContacto(HttpServletRequest request) {
        ...
        if (accion.equals("index")) {
            ...
            contacto.setTop_aux(contacto.getTop_aux() == 0 ? Integer.MAX_VALUE : contacto.getTop_aux());//MAX_VALUE: para manejar todos los 
        }
    ...
    private void doPostRequestCreate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {// si recibimos un valor diferente a cero significa que obtuvimos exito.
                request.setAttribute("accion", "index");
                doGetRequestIndex(request, response);// doGetRequestIndex me llena la lista con 10 registros 
            } else {
    ...
    private void doGetRequestDetails(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        requestObtenerPorId(request, response);// requestObtenerPorId: va a la base de datos a llamar el registro segun el id 
        request.getRequestDispatcher("Views/Contacto/details.jsp").forward(request, response);
    }
    
    private void doGetRequestDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        requestObtenerPorId(request, response);
        request.getRequestDispatcher("Views/Contacto/delete.jsp").forward(request, response);// getRequestDispatcher: llamamos al JSP llamando delete 
    }
    ...
    // Hay metodos pares por que uno muestra el formulario y otro ejecuta la accion 
